...
0.  __A library is not a luxury but one of the necessities of life:__ Create the dynamic library libdynamic.so containing all the functions listed below:
